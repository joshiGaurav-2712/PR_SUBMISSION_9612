...
# OUTPUT
# PS C:\Users\SCI\OneDrive\Desktop\Gaurav Joshi Codes\AI EXPS> python 9612_Exp_10.py
# Enter the number of cities: 5
# Enter coordinates for city 1 (format: x y): 0 0
# Enter coordinates for city 2 (format: x y): 1 2
# Enter coordinates for city 3 (format: x y): 3 1
# Enter coordinates for city 4 (format: x y): 5 3
# Enter coordinates for city 5 (format: x y): 4 6
